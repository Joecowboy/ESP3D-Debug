...
// Define ESP_SAVE_SETTINGS to enable full ESP3DSettings class
...
#define BEARSSL_MFLN_SIZE 256 // Reduced from 512 to save memory
#define BEARSSL_MFLN_SIZE_FALLBACK 2048 // Reduced from 4096
