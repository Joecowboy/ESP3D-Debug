...
#else
#define GLOBAL_FILESYSTEM_FEATURE // Enable GLOBAL_FILESYSTEM_FEATURE if FTP_FEATURE is defined
#endif
#endif
...
#else
#define GLOBAL_FILESYSTEM_FEATURE // Enable GLOBAL_FILESYSTEM_FEATURE if WEBDAV_FEATURE is defined
#endif
#endif
