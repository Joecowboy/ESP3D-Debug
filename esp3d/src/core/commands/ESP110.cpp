...
void ESP3DCommands::ESP110(int cmd_params_pos, ESP3DMessage* msg) {
  ...
  if (tmpstr.length() == 0) {
    ...
    switch (byteValue) {
      case ESP3DNetworkMode::bluetooth:         ok_msg = "BT"; break;
#if defined(WIFI_FEATURE)
      case ESP3DNetworkMode::wifi_ap:          ok_msg = "WIFI-AP"; break;
      case ESP3DNetworkMode::wifi_sta:         ok_msg = "WIFI-STA"; break;
      case ESP3DNetworkMode::wifi_apsta:       ok_msg = "WIFI-AP+STA"; break;
      case ESP3DNetworkMode::ap_setup:         ok_msg = "WIFI-SETUP"; break;
#endif
#if defined(ETH_FEATURE)
      case ESP3DNetworkMode::eth_sta:          ok_msg = "ETH-STA"; break;
#endif
      case ESP3DNetworkMode::no_network:       ok_msg = "OFF"; break;
    ...
    tmpstr.toUpperCase();
    if      (tmpstr == "BT")           byteValue = ESP3DNetworkMode::bluetooth;
#if defined(WIFI_FEATURE)
    else if (tmpstr == "WIFI-AP")      byteValue = ESP3DNetworkMode::wifi_ap;
    else if (tmpstr == "WIFI-STA")     byteValue = ESP3DNetworkMode::wifi_sta;
    else if (tmpstr == "WIFI-AP+STA")  byteValue = ESP3DNetworkMode::wifi_apsta;
    else if (tmpstr == "WIFI-SETUP")   byteValue = ESP3DNetworkMode::ap_setup;
#endif
#if defined(ETH_FEATURE)
    else if (tmpstr == "ETH-STA")      byteValue = ESP3DNetworkMode::eth_sta;
#endif
    else if (tmpstr == "OFF")          byteValue = ESP3DNetworkMode::no_network;
